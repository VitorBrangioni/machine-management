...
<head>
  ...
  <link rel="stylesheet" href="{{ URL::asset('assets/vendor/datatables/dataTables.bootstrap4.css') }}" />
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">Machines Management</a>
  ...
  <div class="content-wrapper">
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright © VitorBrangioni - Machine Management</small>
        </div>
      </div>
    </footer>
    ...
    <script type="text/javascript" src="{{ URL::asset('assets/vendor/jquery-easing/jquery.easing.min.js') }}"></script>
    <!-- Page level plugin JavaScript-->
    {{-- <script src="vendor/datatables/jquery.dataTables.js"></script> --}}
    {{-- <script src="vendor/datatables/dataTables.bootstrap4.js"></script> --}}
    <script type="text/javascript" src="{{ URL::asset('assets/vendor/datatables/jquery.dataTables.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('assets/vendor/datatables/dataTables.bootstrap4.js') }}"></script>
    <!-- Custom scripts for all pages-->
    {{-- <script src="js/sb-admin.min.js"></script> --}}
    <script type="text/javascript" src="{{ URL::asset('assets/js/sb-admin.min.js') }}"></script>
